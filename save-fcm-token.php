<?php
    ...
    if(mysqli_num_rows($d1) == 0) {
        ...
        mysqli_query($con1, "update app_user_auth set fcm_token='$_REQUEST[fcm_token]' where user_id='$_REQUEST[s_id]' and user_type='$_REQUEST[user_type]' and college_id='$_REQUEST[college_id]' and device_id='$_REQUEST[device_id]' ");
    }
